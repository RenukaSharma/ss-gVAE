...
mask_dir = (os.environ.get("RESULTS_DIR", "./results") + "/mvtec_anomaly_detection_textureANDobject/textures/carpet/ground_truth/not_good")
defect_type="thread" # to change
dest_dir = (os.environ.get("RESULTS_DIR", "./results") + "/mvtec_AD_dataset/carpet-with-novel-ano-in-test/train")
