...
def create_semisupervised_setting(labels, normal_classes, outlier_classes, known_outlier_classes,
    ...
    logger.info('Preprocessing, creating semi-supervised setting')
    ...
    logger.info(f'Number of known outliers are: n_known_outlier {n_known_outlier} | n_unlabeled_outlier: {n_unlabeled_outlier} '
                        f'| n_unlabeled_normal: {n_unlabeled_normal} | n_known_normal: {n_known_normal}')

    print("Number of known outliers are:", n_known_outlier, n_unlabeled_outlier, n_unlabeled_normal, n_known_normal)
