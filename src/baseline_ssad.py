...
def main(dataset_name, xp_path, data_path, load_config, load_model, ratio_known_normal, ratio_known_outlier,
         ratio_pollution, seed, kernel, kappa, hybrid, device, load_ae, n_jobs_dataloader, normal_class, known_outlier_class,
    ...
    ssad.train(dataset, device=device, n_jobs_dataloader=n_jobs_dataloader, dataset_name=dataset_name)

    # Test model
    ssad.test(dataset, device=device, n_jobs_dataloader=n_jobs_dataloader, dataset_name=dataset_name)
