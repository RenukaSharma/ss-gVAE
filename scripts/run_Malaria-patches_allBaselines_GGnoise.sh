...
# full supervision
res_dir="${RESULTS_DIR}/results_bayesian_Malaria-patchwise/BS-128/no-noise_0.1-pollution_inv-loss-noveltest_May23_D_recon_loss"
mkdir -p ${res_dir}
...
do
    ...
    do
        ...
        do
            for recon_param in 100 1000 # 0.5 # 2 # 1 2 4 # 6 8 10 1
            do  
                for latent_param in 0.1 1 # 0.5 # 2 # 1 0.1  # 0.1 1
                do
                    for eta in 1 #  4 # 5 10 # 4 8 10
                    do
                        for ratio_l in 0.2 0.49 0.1 0.05 0.01 0 # 0.05 0.01 0 # 0.2 0.1 0.05 0.01 0
                        do 
                            for baseline in C # B C D E A # VAE
                            do                       
...
res_dir="${RESULTS_DIR}/results_bayesian_Malaria-patchwise/BS-128/no-noise_0.1-pollution_inv-loss-noveltest_May23"
mkdir -p ${res_dir}
for n_known_outlier_classes in 1 
do
    for i in {1..2}
