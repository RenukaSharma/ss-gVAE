...
mkdir -p ${RESULTS_DIR}/results_bayesian_Malaria_1000
mkdir -p ${RESULTS_DIR}/results_bayesian_Malaria_1000/newMethod-Dec27-20
res_dir="${RESULTS_DIR}/results_bayesian_Malaria_1000/newMethod-Dec27-20/BS-128"
mkdir -p ${res_dir}
