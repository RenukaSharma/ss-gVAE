...
res_dir="${RESULTS_DIR}/results_bayesian_Malaria-patchwise/BS-128/with-SPnoise-no-pollution-inv-loss/baseline-ssad-hybrid-withVarLearning"
mkdir -p ${res_dir}
for i in {0..4}
do
...
res_dir="${RESULTS_DIR}/results_bayesian_Malaria-patchwise/BS-128/with-SPnoise-no-pollution-inv-loss/baseline-ssad"
mkdir -p ${res_dir}
for i in {0..4}
do
    for n_known_outlier_classes in 1
